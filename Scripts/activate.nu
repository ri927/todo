...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\rikuto osawa\OneDrive\デスクトップ\Flask\practiceApp'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\rikuto osawa\OneDrive\デスクトップ\Flask\practiceApp\Scripts\deactivate.nu'
